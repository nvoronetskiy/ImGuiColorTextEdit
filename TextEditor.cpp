...
const TextEditor::Language* TextEditor::Language::SQL() {
	...
	if (!initialized) {
		...
		static const char* const keywords[] = {
			 ...
			 "LEAST", "LEFT", "LIKE", "LIKE_REGEX", "LISTAGG", "LN", "LOCAL", "LOCALTIME", "LOCALTIMESTAMP", "LOG", "LOG10",
			 ...
			 "VAR_SAMP", "VERSIONING", "WHEN", "WHENEVER", "WHERE", "WIDTH_BUCKET", "WINDOW", "WITH", "WITHIN", "WITHOUT", "YEAR", "LIMIT"
		};
